...
Beacon.prototype.advertiseUid = function (namespaceId, instanceId, options) {
  ...
  this._advertisementData = AdvertisementData.makeUidBuffer(
    namespaceId,
    instanceId,
    this._txPowerLevel
  );
...
Beacon.prototype.advertiseUrl = function (url, options) {
  ...
  this._advertisementData = AdvertisementData.makeUrlBuffer(
    url,
    this._txPowerLevel
  );
  this._removeFlagsIfOsX();
...
Beacon.prototype.advertiseTlm = function () {
  this._advertisementData = AdvertisementData.makeTlmBuffer(
    this._batteryVoltage,
    this._temperature,
    this._advCnt,
    this._secCnt
  );
